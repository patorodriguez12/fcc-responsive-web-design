export default function CatPhotoApp() {
  return (
    <div>
      <main>
        <h1>CatPhotoApp</h1>
        ...
        <section>
          ...
          <form action="https://freecatphotoapp.com/submit-cat-photo">
            ...
            <fieldset>
              ...
              <input checked="loving" type="checkbox" name="personality" />
              <label for="loving">Loving</label>
              <input checked id="lazy" type="checkbox" name="personality" />
      ...
      <footer>
        <p>
          ...
          <a href="https://github.com/patorodriguez12">
